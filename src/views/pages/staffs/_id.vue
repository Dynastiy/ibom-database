            ...
            <section class="right__side">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active top" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                            Profile
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link top" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
                            Bank Details
                            </a>
                    </li>
                ...
                <div class="mt-3">
                    <button>Activate Staff</button>
                    <button>Deactivate User</button>
                    <button>Ban Staff</button>
                    <button>Unban Staff</button>
                </div>
            </section>
        </div>
    </div>
